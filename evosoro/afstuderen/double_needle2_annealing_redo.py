...
from evosoro.tools.algorithms import AnnealingOptimization
...
RUN_DIR = "annealing_redo_data"  # Subdirectorywhere results are going to be generated
RUN_NAME = "annealing_redo"
