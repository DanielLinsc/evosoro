...
from evosoro.tools.algorithms import ParetoOptimizationDiversifyAncestry
...
RUN_DIR = "ancestor_redo2a_data"  # Subdirectorywhere results are going to be generated
RUN_NAME = "ancestor_redo2a"
CHECKPOINT_EVERY= 20  # How often to save an snapshot of theexecution state to later resume the algorithm
